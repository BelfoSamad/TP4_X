package dz.exampleesisba.msformation;

import dz.exampleesisba.msformation.dao.FormationRepository;
import dz.exampleesisba.msformation.entities.Formation;
...
public class MsFormationApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Formation f2 = formationRepository.save(new Formation(null, "Angular", 30));
    }
}
